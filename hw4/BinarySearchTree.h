 ...
 *  Header file for BinarySearchTree class. Also contains the Node struct
 *  Modified by: Jun Sung Tak
 *  Date: 27 Feb 2019
 *  NOTE: Two new private function has been added to
 *        better modularize the algorithm (newNode() and remove_helper())
 */
